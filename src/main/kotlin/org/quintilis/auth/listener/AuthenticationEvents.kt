...
class AuthenticationEvents(
    ...
    fun onSuccess(event: AuthenticationSuccessEvent) {
        ...
        val isBackgroundToken =
                authentication.javaClass.simpleName == "OAuth2ClientAuthenticationToken" ||
                        authentication.javaClass.simpleName == "JwtAuthenticationToken"
        ...
        if (!isBackgroundToken) {
            ...
            if (user != null) {
                ...
                println(
                        "AVISO: Login bem sucedido mas usuário não encontrado no banco para log: $identifier"
                )
            }
        }
    }
